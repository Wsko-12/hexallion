...
class FieldCeil {
  constructor(properties) {
    ...
    this.blockCeil = properties.type === 'meadow' || properties.type === 'sea' || properties.type === 'sand' || properties.type === 'steelMine' ? false : true;
  ...
  showSectorMenu(sector) {
    if (this.type === 'meadow' || this.type === 'sand' || this.type === 'steelMine') {
  ...
  buildOnSector(sector, building) {
    if (this.sectors[sector] === null) {
      ...
      if (building === 'bridge') {
        let lightGeometry;
        if (this.neighbours[sector].type === 'meadow' || this.neighbours[sector].type === 'sand' || this.neighbours[sector].type === 'steelMine' || this.neighbours[sector].cityCeil) {
