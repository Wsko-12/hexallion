...
TUTORIAL.start = function(){
  ...
  const content = {
    ...
    body:` 
    Изначально эта игра задумывалась как настольная, но из-за того, что не всегда есть возможность собраться с друзьями, я решил написать ее веб версию.
    В итоге увлекся и сделал из нее полноценную настольную видеоигру.
    <br/>
    <br/>
    Это экономическая стратегия, в которой вам предстоит строить заводы и производства, а в дальнейшем продавать продукцию в города.
    <br/>
    <br/>
    Однако, не все так просто. Вам нужно будет следить за спросом на продукцию, за логистикой, ну и элемент удачи никто не отменял.
    <br/>
    <br/>
    В каждой новой игре клетки на поле будут раскладываться случайным образом, поэтому выстраивать победную тактику придется по-разному.
    <br/>
    <br/>   
    Ваша задача - выбить всех конкурентов с рынка, обанкротив их. Ну, обо всем по порядку.
    <br/>
    <br/> 
    Если вы используете устройство на Android, то рекомендую зайти в настройки и включить full screen.
        `,
    button:'Далее',
    fn:function(){
      const content = {
          ...
          <br/>            
          - Процент, который игрок платит за кредит
          <br/>
           - Отсрочка —  количество шагов до первого платежа по кредиту
           <br/>
           - Общее количество платежей
           <br/>   
           - Сумма платежа за ход
           <br/>   
           <br/>   
           Когда заканчивается отсрочка, с баланса игрока начинают списываться платежи по кредиту.
          `,
          button:'Выбрать',
          fn:function(){
...
TUTORIAL.truck_3 = function(){
  ...
  TUTORIAL.second({
    body:`
      Грузовик может перемещаться на столько клеток, сколько выпало на кубике.
      <br/>
      <br/>
